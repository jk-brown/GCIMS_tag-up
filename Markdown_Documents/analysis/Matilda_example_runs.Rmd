...
ini_list <- list(
ssp119 = system.file("input/hector_ssp126.ini", package = "hector"), 
ssp126 = system.file("input/hector_ssp245.ini", package = "hector"), 
ssp245 = system.file("input/hector_ssp370.ini", package = "hector"),
ssp370 = system.file("input/hector_ssp585.ini", package = "hector") 
)
...
init_result <- parLapply(cluster, names(ini_list), function(name) {
